...
public class DES
{
    ...
    public static String pc2(String roundL, String roundR) {
        ...
        String temp = "";
        int[] table = { 13, 16, 10, 23, 0, 4, 2, 27, 14, 5, 20, 9, 22, 18, 11, 3, 25, 7, 15, 6, 26, 19, 12, 1, 40, 51,
    ...
    public String InvIP(String binary) {
        int[] invIPTable = new int[] { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54,
    ...
    public int[] expandBytes(int[] rightBlock) {
        ...
        for (int aByte = 0; aByte <= 2; aByte++) {
            ...
            expandedBytes[aByte
                    + 3] = (expandedBytes[aByte + 3] | (expandedUpperBytes & (255 << (aByte * 8)))) >> (aByte * 8);
        }
